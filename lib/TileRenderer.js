...
var TileRenderer = function (options) {
    ...
    this._program = createProgram(this._gl, elevationGradientVert, elevationGradientFrag);

    this._gradient = [
        { r: 0, g: 0, b: 0, a: 0, z: 70 },
        { r: 1, g: 0, b: 0, a: 1, z: 70 },
        { r: 1, g: 1, b: 0, a: 1, z: 80 },
        { r: 0, g: 1, b: 1, a: 1, z: 90 },
        { r: 0, g: 0, b: 1, a: 1, z: 95 },
        { r: 0, g: 0, b: 0, a: 0, z: 95 },
    ]
};
...
TileRenderer.prototype.render = function (heights, maskSamples, gridDim, tileDimension, gradientMinElevation, gradientMaxElevation, opacityMinElevation, majorContour, minorContour, gradOpacity) {
    var gl = this._gl;
    var canvas = this._canvas;
    var program = this._program;

    var maskBuffer = new ArrayBuffer(heights.length);
    ...
    var setUniformI = function () {
        ...
        switch (type) {
            case 1:
                ...
                break;
            case 2:
                gl.uniform2i(location, arguments[1], arguments[2]);
                break;
            case 3:
                gl.uniform3i(location, arguments[1], arguments[2], arguments[3]);
                break;
        }
    };
    ...
    setUniformI("u_gradientStopCount", gradient.length)
