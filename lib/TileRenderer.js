...
class TileRenderer {
    constructor({ width, height, gradient, gradientAmount, hillshadeAmount, contourAmount, majorContour, minorContour }) {
        ...
        const modifiedFragmentShader = elevationGradientFrag.replace(/GRADIENT_STOP_COUNT/g, this.gradientStops.length.toString())
    ...
    render(
        ...
        const { gl, program, canvasElement, gradientStops, majorContour, minorContour, gradientAmount, contourAmount } = this
